...
### EPA NWCA 2016 Veg Species Data for: `r paste(site_df$NWCA_codes[site_df$Local_Name == params$site], site_df$Full_Name[site_df$Local_Name == params$site], sep = ": ")`

```{r spptab}
make_spp_kable(params$site)
```
